...
<body>
    <nav class="navbar" id="navbar" role="navigation" aria-label="Huvudnavigation">
        <div class="nav-container">
            <a href="index.php" class="logo" aria-label="Vilches Entreprenad startsida">
                <img src="../img/PhotoRoom_20230105_2046454.png" alt="Vilches Entreprenad logotype" width="150" height="54">
            </a>

            <ul class="nav-menu" id="navMenu" role="menubar">
                <li role="none">
                    <a href="index.php" class="active" role="menuitem">Hem</a>
                </li>
                <li role="none">
                    <a href="malare.php" role="menuitem">MÅLARE</a>
                </li>
                <li role="none">
                    <a href="snickare.php" role="menuitem">SNICKARE</a>
                </li>
                <li role="none">
                    <a href="renovering.php" role="menuitem">RENOVERING</a>
                </li>
                <li role="none">
                    <a href="montage.php" role="menuitem">MONTAGE</a>
                </li>
            </ul>

            <button class="mobile-menu-toggle" id="mobileToggle" aria-expanded="false" aria-controls="navMenu" aria-label="Öppna navigationsmeny">
